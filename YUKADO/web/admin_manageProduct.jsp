<%-- 
    ...
    Created on : 26 Nov, 2016, 7:48:56 PM
    Author     : yukado
--%>
...
<html>
    ...
    <title>MyCom24 -manageProduct</title>
...
%>
    ...
    <%        } else {
    %>
    <jsp:include page="includesPage/_logout_1.jsp"></jsp:include>
    <%            }
...
%>
        ...
        <div class="grid_2">
            ...
            <div class="grid_6">
                <p id="info"><a href="admin_manageProduct.jsp?pid=<%=product_id%>"><h3><span class="blue"> <%=product_name%></span></h3></a>By <%= company_name + " " + category_name%><br/><span class="red">Euro <%= price%></span></p>
