...
/*
                        ...
                        <div class="grid_14">
                            <div class="grid_10">
                                <p id="info"><a href="product.jsp?id=<%=product_id%>"><h3 style="font-weight: bold; font-size: 18px"><span class="blue"><%=product_name %></br>Von: <%= company_name%></h3></br>Kategorie: "<%= category_name +" / "+ sub_category_name %><br/></a><span class="red"><%= price %> Euro</span></p>
                            </div>
                            <div class="grid_3">
                                <p> <a href="addToCart.jsp?id=<%= product_id %>" id="greenBtn">in den Warenkorb</a></p><p>Lieferung in 3 Werktagen</p>
                            </div>
                        </div>
