...
<html>
    <head>
        ...
        -->
        <link rel="stylesheet" type="text/css" href="css/styles.css_1"  />

        <link rel="stylesheet" type="text/css" href="css/product.css_1"  />
...
<body>
    ...
    <%@include file="includesPage/_joinNow1.jsp" %>
    <%//@include file="includesPage/_topLogin.jsp" %>

    <%    } else {
    %>

    <%@include file="includesPage/_logout_1.jsp" %>

    <%        }
    %>

    <%@include file="includesPage/_search_navigationbar1.jsp" %>
            ...
            <div class="grid_10 push_3">
                <form method="GET" action="addProduct">
                    <div class="grid_10">
                        <div class="grid_9">
                            ...
                            <table class="stepTable">
                                ...
                                <tr>
                                    <td><h4>Datum</h4></td>
                                    <td>                       
                        <input type="text" name="lastUpdated" placeholder="2017-08-23 01:03:12"/>
                        ...
                        <input id="greenBtn" type="submit" value ="OK" />
                    </div>
                </form>
