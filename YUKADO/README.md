...
### Guide to installing yukado into your machine
...
* MySQL Database with the same name as the project, (Use an Xampp/Wamp)
* Given the MySQL File (.sql) Under jLibs directory of project yukado, Import the file into your database and you have your tables ready
