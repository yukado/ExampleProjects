    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (companyName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany = "INSERT INTO  `163_mycom`.`product-company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";  
                //String sqlInsertProduct = "INSERT INTO  `enterprises`.`category` (`category_id` ,`category_name`)VALUES (NULL ,  '"+companyName+"'); ";
